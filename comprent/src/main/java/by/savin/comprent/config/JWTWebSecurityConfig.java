...
import by.savin.comprent.security.JwtTokenAuthorizationOncePerRequestFilter;
import by.savin.comprent.security.JwtUnAuthorizedResponseAuthenticationEntryPoint;
...
public class JWTWebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf()
                ...
                .antMatchers(HttpMethod.DELETE, "/item").hasAuthority("ADMIN")
                .antMatchers(HttpMethod.PUT, "/item").hasAuthority("ADMIN")
                .antMatchers(HttpMethod.DELETE, "/remove").hasAuthority("USER");
